  ...
  : wxDialog(parent, wxID_ANY, title, wxDefaultPosition, wxSize(393, 177), wxDEFAULT_DIALOG_STYLE)
{
  ...
  bSizer2->Add(ClassCombo, 1, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));
  ...
  wxPanel* m_panel1;
  m_panel1 = new wxPanel(this, wxID_ANY, wxDefaultPosition, FromDIP(wxSize(-1, 35)), wxTAB_TRAVERSAL);
  wxBoxSizer* bSizer3;
...
DebugObjectPicker::DebugObjectPicker(wxWindow* parent)
  : WXDialog(parent, wxID_ANY, wxT("Enter object index..."))
{
  ...
  wxStaticText* m_staticText = new wxStaticText(m_panel1, wxID_ANY, wxT("Object index: "), wxDefaultPosition, wxDefaultSize, 0);
  m_staticText->Wrap(-1);
  bSizer2->Add(m_staticText, 0, wxALIGN_CENTER_VERTICAL | wxALL, FromDIP(5));

  CompositeName = new wxTextCtrl(m_panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER);
  ...
  OpenButton = new wxButton(m_panel2, wxID_OK, wxT("Select"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  OpenButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(DebugObjectPicker::OnOkClicked), NULL, this);
  CancelButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(DebugObjectPicker::OnCancelClicked), NULL, this);
  CompositeName->Connect(wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(DebugObjectPicker::OnTextEnter), NULL, this);
  CompositeName->Connect(wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(DebugObjectPicker::OnText), NULL, this);
}

PACKAGE_INDEX DebugObjectPicker::GetResult() const
{
  return Result;
}

void DebugObjectPicker::OnText(wxCommandEvent&)
{
  OpenButton->Enable(CompositeName->GetValue().size());
}

void DebugObjectPicker::OnTextEnter(wxCommandEvent&)
{
  try
  {
    Result = wxAtoi(CompositeName->GetValue());
  }
  catch (...)
  {
    CompositeName->SetFocus();
    return;
  }
  EndModal(wxID_OK);
}

void DebugObjectPicker::OnOkClicked(wxCommandEvent&)
{
  EndModal(wxID_OK);
}

void DebugObjectPicker::OnCancelClicked(wxCommandEvent&)
{
  EndModal(wxID_CANCEL);
}