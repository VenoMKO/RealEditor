  ...
  , Patcher(FPackage::GetCompositePackageMapPath().WString())
{
  ...
  m_staticText29->Wrap(FromDIP(520));
  bSizer12->Add(m_staticText29, 0, wxALL | wxEXPAND, FromDIP(5));

  wxStaticLine* m_staticline3;
  m_staticline3 = new wxStaticLine(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL);
  bSizer12->Add(m_staticline3, 0, wxEXPAND | wxALL, FromDIP(5));
  ...
  bSizer13->Add(m_staticText14, 0, wxALIGN_CENTER_VERTICAL | wxALL, FromDIP(5));
  ...
  bSizer13->Add(SourceField, 1, wxALIGN_CENTER_VERTICAL | wxALL, FromDIP(5));
  ...
  bSizer13->Add(SelectButton, 0, wxALIGN_CENTER_VERTICAL | wxALL, FromDIP(5));


  bSizer12->Add(bSizer13, 0, wxEXPAND, FromDIP(5));

  wxStaticLine* m_staticline2;
  m_staticline2 = new wxStaticLine(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL);
  bSizer12->Add(m_staticline2, 0, wxEXPAND | wxALL, FromDIP(5));
  ...
  bSizer23->Add(m_staticText17, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  ContainerField = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
  bSizer23->Add(ContainerField, 1, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  wxStaticText* m_staticText27;
  m_staticText27 = new wxStaticText(this, wxID_ANY, wxT("Name:"), wxDefaultPosition, wxDefaultSize, 0);
  m_staticText27->Wrap(-1);
  bSizer23->Add(m_staticText27, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  CompositeNameField = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
  bSizer23->Add(CompositeNameField, 1, wxALL, FromDIP(5));


  bSizer12->Add(bSizer23, 0, wxEXPAND, FromDIP(5));
  ...
  bSizer27->Add(m_staticText18, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  ObjectField = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
  bSizer27->Add(ObjectField, 1, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));


  bSizer12->Add(bSizer27, 0, wxEXPAND, FromDIP(5));
  ...
  bSizer231->Add(m_staticText171, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  OffsetField = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
  bSizer231->Add(OffsetField, 1, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  wxStaticText* m_staticText181;
  m_staticText181 = new wxStaticText(this, wxID_ANY, wxT("Size:"), wxDefaultPosition, wxDefaultSize, 0);
  m_staticText181->Wrap(-1);
  bSizer231->Add(m_staticText181, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  SizeField = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
  bSizer231->Add(SizeField, 1, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  SizeButton = new wxButton(this, ControlElementId::Size, wxT("Get Size"), wxDefaultPosition, wxDefaultSize, 0);
  bSizer231->Add(SizeButton, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  bSizer12->Add(bSizer231, 0, wxEXPAND, FromDIP(5));
  ...
  bSizer28->Add(m_panel9, 1, wxEXPAND | wxALL, FromDIP(5));

  PatchButton = new wxButton(this, ControlElementId::Patch, wxT("Patch"), wxDefaultPosition, wxDefaultSize, 0);
  PatchButton->Enable(false);

  bSizer28->Add(PatchButton, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));

  CancelButton = new wxButton(this, wxID_CANCEL, wxT("Close"), wxDefaultPosition, wxDefaultSize, 0);
  bSizer28->Add(CancelButton, 0, wxALL | wxALIGN_CENTER_VERTICAL, FromDIP(5));


  bSizer12->Add(bSizer28, 1, wxEXPAND, FromDIP(5));
