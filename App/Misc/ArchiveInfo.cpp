  ...
  , Window(window)
{
  ...
  bSizer15->Add(m_staticText40, 0, wxALL, 5);

  FileVersion = new wxStaticText(m_panel2, wxID_ANY, wxT("-"), wxDefaultPosition, wxDefaultSize, 0);
  FileVersion->Wrap(-1);
  bSizer15->Add(FileVersion, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);
  ...
  bSizer15->Add(m_staticText42, 0, wxALL, 5);

  HeaderSize = new wxStaticText(m_panel2, wxID_ANY, wxT("-"), wxDefaultPosition, wxDefaultSize, 0);
  HeaderSize->Wrap(-1);
  bSizer15->Add(HeaderSize, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);
  ...
  bSizer151->Add(m_staticText401111, 0, wxALL, 5);

  PackageSource = new wxStaticText(m_panel2, wxID_ANY, wxT("-"), wxDefaultPosition, wxDefaultSize, 0);
  PackageSource->Wrap(-1);
  bSizer151->Add(PackageSource, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);


  bSizer13->Add(bSizer151, 0, wxEXPAND, 5);
  ...
  bSizer20->Add(m_staticText80, 0, wxALL, 5);

  GUID = new wxStaticText(m_panel2, wxID_ANY, wxT("-"), wxDefaultPosition, wxDefaultSize, 0);
  GUID->Wrap(-1);
  bSizer20->Add(GUID, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);
  ...
  bSizer19->Add(m_staticText78, 0, wxALL, 5);

  FolderName = new wxStaticText(m_panel2, wxID_ANY, wxT("-"), wxDefaultPosition, wxDefaultSize, wxST_ELLIPSIZE_END);
  FolderName->Wrap(-1);
  bSizer19->Add(FolderName, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);


  bSizer13->Add(bSizer19, 0, wxEXPAND, 5);
  ...
  bSizer191->Add(m_staticText781, 0, wxALL, 5);

  Flags = new wxStaticText(m_panel2, wxID_ANY, wxT("-"), wxDefaultPosition, wxDefaultSize, wxST_ELLIPSIZE_END);
  Flags->Wrap(-1);
  bSizer191->Add(Flags, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);


  bSizer13->Add(bSizer191, 0, wxEXPAND, 5);
  ...
  bSizer201->Add(m_staticText801, 0, wxALL, 5);

  Compression = new wxStaticText(m_panel2, wxID_ANY, wxT("-"), wxDefaultPosition, wxDefaultSize, 0);
  Compression->Wrap(-1);
  bSizer201->Add(Compression, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);


  bSizer13->Add(bSizer201, 0, wxEXPAND, 5);
  ...
  bSizer1911->Add(m_staticText7811, 0, wxALL, 5);
  ...
  bSizer1911->Add(AdditionalPackages, 0, wxTOP | wxBOTTOM | wxRIGHT, 5);


  bSizer13->Add(bSizer1911, 0, wxEXPAND, 5);
  ...
  bSizer13->Add(m_staticText78111, 0, wxALL, 5);

  GenerationsTable = new wxDataViewCtrl(m_panel2, wxID_ANY, wxDefaultPosition, wxSize(350, 100), 0);
  bSizer13->Add(GenerationsTable, 0, wxALL, 5);
  ...
  NamesTable = new wxDataViewCtrl(this, wxID_ANY, wxDefaultPosition, wxSize(270, -1), 0);
  bSizer8->Add(NamesTable, 1, wxALL, 5);


  bSizer35->Add(bSizer8, 0, wxEXPAND, 5);


  bSizer7->Add(bSizer35, 1, wxEXPAND, 5);
  ...
  NamesTable->AppendTextColumn(wxEmptyString, NameDataModel::Col_Idx, wxDATAVIEW_CELL_INERT, 40, wxALIGN_CENTER_HORIZONTAL);
  NamesTable->AppendTextColumn(_("Name"), NameDataModel::Col_Name);

  GenerationsTable->AppendTextColumn(wxEmptyString, GenerationDataModel::Col_Idx, wxDATAVIEW_CELL_INERT, 25, wxALIGN_CENTER_HORIZONTAL);
  GenerationsTable->AppendTextColumn(_("Names"), GenerationDataModel::Col_Names, wxDATAVIEW_CELL_INERT, 95, wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
  GenerationsTable->AppendTextColumn(_("Exports"), GenerationDataModel::Col_Exports, wxDATAVIEW_CELL_INERT, 95, wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
  GenerationsTable->AppendTextColumn(_("Net. Objects"), GenerationDataModel::Col_Network, wxDATAVIEW_CELL_INERT, 95, wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
